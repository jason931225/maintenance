...
-- target's 개인 수신함 (inbox_docs, 0116): `inbox_doc_id` references it. Starting
...
--
-- Depends on 0116_create_inbox_docs (the inbox vault) — this migration, and the
-- PR that ships it, must land AFTER the InboxDoc PR.
--
-- Tenant isolation: RLS keyed on `app.current_org`, FORCE-enabled (0116 idiom).
