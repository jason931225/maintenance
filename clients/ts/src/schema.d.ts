...
export interface paths {
    ...
    "/api/messenger/messages/{messageId}/ack": {
         ...
         * @description Idempotent toggle: if the caller's ack is present it is removed, else added. Returns the post-toggle state and live count. The caller must be a member of the message's thread; a non-member gets 403.
         */
