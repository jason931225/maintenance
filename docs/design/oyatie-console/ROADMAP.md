...
| 복리후생 / benefit | 없음 | tenant-scoped catalog REST + generic lifecycle materialization | development REGISTRY typed CRUD body | PARTIAL | independent runtime/RLS closed-loop evidence·production exposure |
