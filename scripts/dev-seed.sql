...
INSERT INTO notifications (id, org_id, recipient_user_id, category, kind, body, link, unread) VALUES
  ('00000000-0000-0000-0000-000000ce0001', '00000000-0000-0000-0000-0000000000a1', '00000000-0000-0000-0000-00000000d001', 'support', 'ticket_assigned', '새 지원 요청이 배정되었습니다: 지게차 시동 불량 문의', '{"screen":"support","id":"00000000-0000-0000-0000-0000005c0001"}'::jsonb, true),
  ('00000000-0000-0000-0000-000000ce0002', '00000000-0000-0000-0000-0000000000a1', '00000000-0000-0000-0000-00000000d001', 'leave', 'approval_pending', '연차 신청 승인 대기: 김정비 (2일)', '{"screen":"leave","id":"00000000-0000-0000-0000-000000a20001"}'::jsonb, true),
  ('00000000-0000-0000-0000-000000ce0003', '00000000-0000-0000-0000-0000000000a1', '00000000-0000-0000-0000-00000000d001', 'finance', 'voucher_posted', 'GL 전표가 전기되었습니다: GL-2026-0001', '{"screen":"finance","id":"00000000-0000-0000-0000-000000fc0001"}'::jsonb, false)
ON CONFLICT (id) DO NOTHING;
