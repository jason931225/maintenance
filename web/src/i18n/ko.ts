...
export const ko = {
  ...
  eApprovals: {
    ...
    emptyInbox: "결재할 항목이 없습니다.",
    emptyRequests: "상신한 문서가 없습니다.",
    actions: {
      claim: "담당",
      decide: "결재",
      finalize: "종결",
      delegateFinalize: "대행 종결",
      postReject: "사후 반려",
      view: "상세",
      retry: "다시 시도",
    },
    ...
    toasts: {
      ...
      rejected: "거부했습니다.",
      finalized: "종결했습니다.",
      postRejected: "사후 반려했습니다.",
      forbidden: "본인이 기안한 건은 승인할 수 없습니다.",
      actionFailed: "처리하지 못했습니다.",
      commentRequired: "반려·거부 사유를 입력하세요.",
    ...
    detail: {
      ...
      updatedAt: "변동",
      timelineLabel: "진행",
      timelineEmpty: "진행 기록이 없습니다.",
      actionsLabel: "결재선",
      noActions: "대기 중인 결재가 없습니다.",
      commentLabel: "의견",
      reasonLabel: "사유",
    },
  },
