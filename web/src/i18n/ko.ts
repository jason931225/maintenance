...
export const ko = {
  ...
  payroll: {
    ...
    sections: {
      ...
      ledger: "근태 연동 급여대장",
      ledgerDescription:
        "직원 원장, 근태 이벤트, 연차 값을 연결한 급여 검토 라인입니다.",
      plan: "구현 계획",
      planDescription:
  ...
  approvalCompose: {
    title: "전자결재 문서 작성",
    description: "문서 종류, 결재선, 목표일, 비용, 관련자를 같은 객체로 기록합니다.",
    backToList: "목록",
    fields: {
      title: "문서 제목",
      type: "문서 종류",
      relatedPeople: "관련자/부서",
      approvalLine: "결재선",
      body: "본문",
      tracking: "추적 정보",
    },
    placeholders: {
      amount: "예: 1,000,000 / 유급 1일",
      relatedPeople: "예: 경영지원팀, 담당 임원",
    },
    tracking: {
      targetDate: "목표일",
      amount: "금액/비용",
    ...
    templates: {
      "annual-leave": {
        title: "연차 신청서",
        approvalLine: "작성자 -> 부서장 -> 인사/급여",
        linkedObject: "연차·근태·급여",
        targetLabel: "사용일",
        amountLabel: "유급/무급 영향",
      },
      "outing-business-trip": {
        title: "외출·출장 신청서",
        approvalLine: "작성자 -> 부서장",
        linkedObject: "근태 예외·KPI",
        targetLabel: "복귀 예정일",
        amountLabel: "교통/출장비",
      },
      draft: {
  ...
  users: {
    ...
    roles: {
      ...
      ADMIN: "관리자",
      EXECUTIVE: "임원",
      PAYROLL_MANAGER: "급여담당자",
      HQ_PAYROLL_MANAGER: "HQ급여담당자",
      MECHANIC: "정비사",
      RECEPTIONIST: "접수담당",
      MEMBER: "일반 멤버",
    },
  ...
  platform: {
    ...
    groups: {
      ...
      groupRoles: {
        ...
        GROUP_LABOR: "그룹 노무",
        GROUP_FINANCE: "그룹 재무",
        GROUP_MAINTENANCE: "그룹 정비",
        GROUP_PAYROLL: "그룹 급여",
        GROUP_APPROVALS: "그룹 전자결재",
      },
      tenantRoles: {
        MEMBER: "멤버",
        ADMIN: "조직 관리자",
      ...
      accountForm: {
        ...
        groupScope: "관리 범위",
        groupScopeAll: "그룹 전체",
        groupScopeSelected: "선택 법인",
        managedOrgs: "담당/관리 법인",
        submit: "그룹 계정 추가",
        submitting: "추가 중",
