...
export const ko = {
  ...
  financial: {
    ...
    purchase: {
      ...
      optionA: {
        uploadNeedsWorkOrder: "견적 업로드에는 작업지시 번호가 필요합니다.",
        uploadFailed: "견적 파일을 업로드하지 못했습니다.",
        attachmentDownloadFailed: "첨부파일 링크를 열지 못했습니다.",
        draftEquipment: "장비 구매",
        draftNonEquipment: "운영비/AP",
        policyExceptionRequired: "정책 예외 필요",
        policyClear: "정책 통과 가능",
        purchaseType: "구매 유형",
        equipmentPurchase: "장비/정비 구매",
        nonEquipmentPurchase: "비장비 운영비/AP",
        nonEquipmentHint:
          "비장비 요청은 장비 원장에 반영하지 않고 지출결의/AP 경로로 집행됩니다.",
        workOrder: "작업지시 번호",
        workOrderPlaceholder: "견적 업로드와 증빙 연결에 사용",
        lineGrid: "라인 품목 그리드",
        addRow: "행 추가",
        deleteRow: "삭제",
        columns: {
        ...
        approvalPreview: "승인 미리보기",
        approvalPreviewSteps: {
          requesterAdmin: "요청자 → 관리자 승인",
          executiveRequired: "고액 기준 초과 → 임원 최종 승인",
          executiveSkipped: "고액 기준 이하 → 임원 승인 생략",
          equipmentExecution: "지출결의 등록 → 원가원장 집행",
          nonEquipmentExecution: "지출결의 등록 → AP 집행",
        },
        policyChecklist: "정책 체크리스트",
        policies: {
          equipmentRequired: "장비 구매는 K&L 장비 선택 필수",
          quoteRequired: "견적/거래명세표 첨부",
          lineCore: "라인별 품목·분류·수량·단가",
          priceException: "가격 이상치 예외 사유",
        },
        quoteDropzone: "견적 드롭존",
        quoteHelp:
          "작업지시 번호가 있으면 PDF/이미지 견적을 실제 증빙 저장소에 업로드하고 증빙 번호를 자동 연결합니다.",
        quoteUpload: "견적 파일 업로드",
        uploading: "업로드 중",
        linkedEvidence: "연결 증빙",
        totalsVat: "합계/VAT",
        totals: {
          subtotal: "공급가",
          vat: "VAT",
        ...
        structuredException: "구조화 예외",
        exceptionOptions: {
          PRICE_ANOMALY: "가격 이상치",
          MISSING_QUOTE: "견적 부족",
          POLICY_OVERRIDE: "정책 예외",
          BUDGET_OVERRIDE: "예산 초과",
        },
        exceptionPlaceholder: "비교 견적, 긴급 사유, 승인자 등을 구조화해 남기세요.",
        nonEquipmentSource: "비장비 AP",
        noAttachment: "첨부 없음",
        requestLevelEvidence: "요청 단위",
        lineItems: "라인 품목",
        attachments: "첨부 견적/증빙",
        attachmentCountSuffix: "개",
        preferredQuote: "대표 견적",
        referenceAttachment: "참고",
        openAttachment: "열기",
        policyGates: "정책 게이트/예외",
        pass: "통과",
        block: "차단",
      },
