...
function renderBody(roles: string[], featureGrants: string[] = []) {
  const api = {
    GET: vi.fn(async (path: string) => {
      if (path === "/api/v1/compliance/obligations") return { data: { items: [{ id: "cp-1", code: "CP-0001", title: "근로시간 준수", description: "설명", obligation_type: "LEGAL", scope: { kind: "ORG", scope_ref: null, branch_id: null, site_id: null }, owner_user_id: null, severity: "HIGH", status: "ACTIVE", effective_from: null, effective_to: null, review_cadence: null, next_review_on: null, metadata: {}, created_by: "user", updated_by: "user", created_at: "2026-01-01T00:00:00Z", updated_at: "2026-01-01T00:00:00Z" }], limit: 100, offset: 0, total: 1 } };
